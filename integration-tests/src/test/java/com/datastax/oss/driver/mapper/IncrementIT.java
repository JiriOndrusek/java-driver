...
public class IncrementIT {
  ...
  public void should_increment_counters() {
    ...
    dao.increment(ProductRating.incrementFiveStar(productId1));
    dao.increment(ProductRating.incrementFiveStar(productId1));
    dao.increment(ProductRating.incrementFourStar(productId1));

    dao.increment(ProductRating.incrementTwoStar(productId2));
    dao.increment(ProductRating.incrementThreeStar(productId2));
    dao.increment(ProductRating.incrementOneStar(productId2));
  ...
  public interface ProductRatingDao {
    ...
    @Increment
    void increment(ProductRating increment);
  }

  @Entity
  public static class ProductRating {

    public static ProductRating incrementOneStar(UUID productId) {
      return new ProductRating(productId, 1, 0, 0, 0, 0);
    }

    public static ProductRating incrementTwoStar(UUID productId) {
      return new ProductRating(productId, 0, 1, 0, 0, 0);
    }

    public static ProductRating incrementThreeStar(UUID productId) {
      return new ProductRating(productId, 0, 0, 1, 0, 0);
    }

    public static ProductRating incrementFourStar(UUID productId) {
      return new ProductRating(productId, 0, 0, 0, 1, 0);
    }

    public static ProductRating incrementFiveStar(UUID productId) {
      return new ProductRating(productId, 0, 0, 0, 0, 1);
    }
